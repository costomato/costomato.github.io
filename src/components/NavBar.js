        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#hobbies" className={activeLink === 'hobbies' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('hobbies')}>My Hobbies</Nav.Link>
            </Nav>
            <span className="navbar-text">
              <div className="social-icon">
                ...
                <a href="https://costomato.com" target="_blank" rel="noreferrer"><img src={navIcon4} alt="Web" /></a>
              </div>
              <HashLink to='#connect'>
